                       ...
                       <table class="table table-striped table-bordered">
                        ...
                        ?>
                           <tr>
                                ...
                                <td><?=$v['user_name']?></td>
                                <td><?=$v['type_date']?></td><td><?=$v['oamount']?></td><td><?=$v['type']?></td><td><?=!empty($v['attachment_url'])?'<a href="'.$v['attachment_url'].'" target="_blank">Attachment</a>':''?></td>
                                <td><?=$v['approved']?'Approved':'Pending Approval'?></td>
                                <td>
                                    <a href="<?=  base_url($init['langu']."/vo/".$pathname."/approve/".$v[$id_column])?>" class="btn btn-primary" title="<?=$init['lang']['Edit']?>"><i class="glyphicon glyphicon-ok"></i></a>
