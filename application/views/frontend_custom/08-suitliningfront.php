<section class="wrapper select-wrapper">
            ...
            <div class="select-style margin-bottom-30">
                ...
                <div class="grid-item">
                    <a class="opt" data-key="suit-lining-front" data-value="Option 1" href="javascript:;">
                        <img class="rwd" src="<?=base_url('assets/santini/img/jacket-20.svg')?>" alt="Jacket">
                        <span class="type">Option 1</span>
                    </a>
                </div>
                <div class="grid-item">
                    <a class="opt" data-key="suit-lining-front" data-value="Option 2" href="javascript:;">
                        <img class="rwd" src="<?=base_url('assets/santini/img/jacket-21.svg')?>" alt="Trousers">
                        <span class="type">Option 2</span>
                    </a>
                </div>
                </div>
            </div>
