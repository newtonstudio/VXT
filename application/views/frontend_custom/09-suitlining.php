                    ...
                    <div id="tabs">
                      ...
                      <div id="tabs-1" class="panel">
                        <div class="grid grid-2-4-4">
                            <div class="grid-item opt" data-key="suit-lining" data-value="1">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="2">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="3">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="4">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="5">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="6">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="7">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star" aria-hidden="true"></i></span>
                            </div>
                            <div class="grid-item opt" data-key="suit-lining" data-value="8">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star" aria-hidden="true"></i></span>
                            </div>
                        </div>
                      ...
                      <div id="tabs-2" class="panel">
                        <div class="grid grid-2-4-4">
                            <div class="grid-item opt" data-key="suit-lining" data-value="9">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                            </div>
                        </div>
                      ...
                      <div id="tabs-3" class="panel">
                        <div class="grid grid-2-4-4">
                            <div class="grid-item opt" data-key="suit-lining" data-value="10">
                                <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                            </div>
                        </div>
                      ...
                      <div id="tabs-4" class="panel">
                          <div class="grid grid-2-4-4">
                                <div class="grid-item opt" data-key="suit-lining" data-value="11">
                                    <img src="<?=base_url('assets/santini/img/cloth.jpg')?>" class="rwd" alt="">
                                    <span><i class="fa fa-star-o" aria-hidden="true"></i></span>
                                </div>
                            </div>
