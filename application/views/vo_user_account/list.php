                    ...
                    ?>
                       <table class="table table-striped table-bordered">
                           <tr>
                               ...
                               <th>Bank Name</th><th>Bank Holder</th><th>Bank Account No.</th><th>Swift Code</th><th>Status</th>
                        ...
                        ?>
                           <tr>
                                ...
                                <td><?=$v['bankholder']?></td>
                                <td><?=$v['bankaccount']?></td>
                                <td><?=$v['bankswiftcode']?></td>
                                <td><?=$v['validated']?'Validated':'Pending Validated'?></td>
