...
class Vo_default extends CI_Controller {
      ...
      public function __construct() {
            ...
            $this->data['display_name'] = "default";
            $this->data['pathname'] = "default";
            $this->data['view_foldername'] = "vo_default";
            $this->data['id_column'] = "id"; //role_id, product_id,... etc
            $this->data['model_name'] = "Default_model"; //role_id, product_id,... etc
