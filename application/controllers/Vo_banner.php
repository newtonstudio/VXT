...
class Vo_banner extends CI_Controller {
      ...
      public function __construct() {
            ...
            $this->data['display_name'] = "banner";
            $this->data['pathname'] = "banner";
            $this->data['view_foldername'] = "vo_banner";
            $this->data['id_column'] = "banner_id"; //role_id, product_id,... etc
            $this->data['model_name'] = "Banner_model"; //role_id, product_id,... etc
      ...
      public function Submit()
      {
          ...
          $array = array(
             ...
             'slogan_en' => 	  $this->input->post("slogan_en", true),
             'button' => $this->input->post("button", true),    
             'button_link' =>     $this->input->post("button_link", true),
                
             'background_url' =>    $this->input->post("background_url", true),   
