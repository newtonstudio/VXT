...
abstract class BaseFacebook
{
  ...
  public function getUser() {
    if ($this->user !== null) {
	  ...
	  //echo "getUser First Way";
      // we've already determined this and cached the value.
      return $this->user;
    }
	
	//echo "getUser Second Way";
  ...
  protected function getUserFromAvailableData() {
	...
	//force get user from accesstoken
   ...
   */
  public function getLoginUrl($params=array(), $redirect_url="") {
  ...
  protected function getUserFromAccessToken() {
    try {
      ...
      return $user_info['id'];
		...
		//echo "getUserFromAccessToken exception<br/>";
		echo $e->getMessage();
      return 0;
    }
  }
